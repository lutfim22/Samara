package com.android.proyek_manpro.widget;
...
import com.android.proyek_manpro.service.LocationUpdateService;
import com.android.proyek_manpro.utils.AppPreference;
import com.android.proyek_manpro.utils.AppWidgetProviderAlarm;
...
public class LessWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intentStartActivity = new Intent(context, CuacaActivity.class);
